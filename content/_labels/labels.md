...
watch_video:
  ...
  pt_BR: ''
reasons:
  de_DE: Warum das Großbritannien?
  en_US: Reasons to choose the UK
  zh_CN: 投资英国的8大理由
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
key_sectors:
  de_DE: Wichtigste Marktsektoren
  en_US: Key market sectors
  zh_CN: 主要市场部门
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
all_sectors:
  de_DE: Alle Marktsektoren
  en_US: All market sectors
  zh_CN: 全部市场部门
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
simple_investment:
  de_DE: Einfache Investitionsanleitung
  en_US: Simple investment guide
  zh_CN: 简易投资指南
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
...
all_industries:
  de_DE: Alle Branchen
  en_US: All industries
  zh_CN: All industries:CN
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
industry_overviews:
...
form_enter_valid_email:
  ...
  zh_CN: 請以正确的格式输入您的电子邮件，例如 name@domain.com
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
form_phone:
...
form_mailing_list_confirmation:
  de_DE: Ja, ich würde diese Informationen gerne erhalten.
  en_US: Yes, I would like to see this information
  zh_CN: 我希望收到相关的新闻和信息
  ja_JP: ''
  es_ES: ''
  pt_BR: ''
